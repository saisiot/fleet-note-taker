...
**특징:**
- **YAML 메타데이터 태그**: `tags: [태그1, 태그2, 태그3]` 형식으로 태그 관리
...
- 🔍 **OCR 정확도 검증** - 기존 노트의 OCR 내용과 원본 이미지 대조 및 수정
- 🎯 **태그 품질 향상** - 내용 기반 의미있는 한글 태그 적용
- 📋 **CLAUDE.md 추가** - Claude Code 작업 효율성 향상을 위한 가이드
